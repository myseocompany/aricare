<x-app-layout class="w-full h-screen">
    <!-- contenedor general -->
    <div class="flex flex-row w-full h-screen gap-1">
        <!-- side bar -->
        <div class="side-bar-container flex flex-col w-[15%] h-full bg-white shadow-[4px_0_6px_-1px_rgba(0,0,0,0.3)] text-left px-3 overflow-y-auto">
            <!-- contenedor del logo -->
            ...
            <span>Opciones</span>
            <div class="element flex flex-row gap-3 cursor-pointer my-3 items-center">
            ...
            <div class="options-container flex flex-col w-full mt-1">
                <div class="element flex flex-row gap-3 cursor-pointer my-3">
        ...
        <!-- fin del side bar -->
        <!-- contenedor de navbar y contenido -->
        <div class="element-container flex flex-col w-[85%] h-full">
            <nav class="w-full h-[65px] bg-white flex flex-row justify-between items-center px-4">
                <h2 class="cursor-pointer">Home</h2>
                <button class="flex flex-row justify-between items-center px-1 gap-[5px]">
            ...
            <!-- contenedor despues del navar "header" -->
            <main class="main-container w-full h-screen bg-gray-100 flex flex-col justify-center items-center gap-[10px]">
                <div class="alert-container w-[90%] h-[70px] bg-white flex flex-col items-start px-3">
                    <h3 class="text-red-500">Atención</h3>
                    <span>Tienes una cita pendiente para: </span>
                </div>
                <div class="info-container relative w-[90%] h-[350px] bg-white flex flex-wrap gap-4 p-3">

<x-app-layout>
    <div class="flex flex-row h-screen">
        ...
        <div class="side-bar-container flex flex-col w-[15%] h-full bg-white shadow-[4px_0_6px_-1px_rgba(0,0,0,0.3)] text-left px-3">
            <!-- contenedor del logo -->
            <div class="logo-container flex items-center gap-2 justify-between mt-3">
                ...
                <!-- link dashboard -->
                <a class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium leading-5 text-gray-900 focus:outline-none focus:border-indigo-700 transition duration-150 ease-in-out no-underline" href="http://127.0.0.1:8000/dashboard">
                    Dashboard
                </a>
            </div>
            ...
            <div class="account-options-container flex flex-col">
                <span class="mb-3">Configuracioón de cuenta</span>
                <div class="ms-3 relative">
                    <div class="relative" x-data="{ open: false }" @click.away="open = false" @close.stop="open = false">
                        <div @click="open = ! open">
                            <!-- Toggle Button -->

...
=======
            <a href="{{ route('doctor-profiles.index') }}" class="no-underline text-gray-500 hover:text-blue-700">
                <span>Doctors</span>
            </a>
        </div>
>>>>>>> 2428261 (Tablas de lookUp para cuenta de empresa)
...
=======
            <a href="{{ route('patient-profiles.index') }}" class="no-underline text-gray-500 hover:text-blue-700">
                <span>Pacientes</span>
            </a>
>>>>>>> 2428261 (Tablas de lookUp para cuenta de empresa)
        </div>        
